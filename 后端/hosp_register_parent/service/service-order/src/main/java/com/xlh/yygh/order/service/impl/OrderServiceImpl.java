package com.xlh.yygh.order.service.impl;
...
import com.xlh.yygh.hosp.client.HospitalFeignClient;
import com.xlh.yygh.model.order.OrderInfo;
import com.xlh.yygh.model.user.Patient;
import com.xlh.yygh.order.mapper.OrderInfoMapper;
import com.xlh.yygh.order.service.OrderService;
import com.xlh.yygh.user.client.PatientFeignClient;
...
public class OrderServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderService {
    ...
    public Object saveOrder(String scheduleId, Long patientId) {
        ...
        System.out.println(new DateTime(scheduleOrderVo.getStartTime()));
        System.out.println(new DateTime(scheduleOrderVo.getEndTime()));
        //当前时间不可以预约
