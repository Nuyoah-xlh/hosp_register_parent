  ...
  <div class="nav-container page-component">
    ...
    <div class="page-container">
      <div>
        ...
        <div class="form-wrapper" v-if="userInfo.authStatus == 1">
          <div>
            <el-form
              :model="userAuah"
              label-width="110px"
            ...
            >
              ...
              <el-form-item prop="certificatesType" label="证件类型：">
                ...
                >
                  <el-option
                    v-for="item in certificatesTypeList.data"
                    :key="item.value"
                    :label="item.name"
                    :value="item.name"
                  >
        ...
        <div class="context-container" v-if="userInfo.authStatus != 0">
          <div>
            ...
            >
              <el-form-item prop="name" label="姓名：" class="form-normal" v-if="userInfo.name">
                <div class="name-input">
                  {{ userInfo.name }}
                </div>
              </el-form-item>
              <el-form-item prop="name" label="证件类型：" v-if="userInfo.certificatesType">
                {{ userInfo.certificatesType }}
              </el-form-item>
              <el-form-item prop="name" label="证件号码：" v-if="userInfo.certificatesNo">
  ...
  methods: {
    ...
    getDict() {
      dictApi.findByDictCode("CertificatesType").then(response => {
        this.certificatesTypeList = response
